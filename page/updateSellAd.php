...
if (!$auth) {
    $_SESSION['ERROR'] = "Update Selling Advertisement need to login";
    header("location: /?route=login");
} else {
    if ( ($_SESSION['customer']['id'] == $car['ownerId']) || ($_SESSION['admin']['id']) == $car['ownerId'] ) {
?>
    <div class="container">
        ...
        <form action="/handler/updateSellAd.php" method="post">
