...
if ((isset($_SESSION['customer']) || isset($_SESSION['admin']))) {
    ...
    $record_success = insertPrepare('cars',
        ['name', 'description', 'photoLocation', 'retailPrice', 'productCost', 'oldCar', 'ownerId', 'sold', 'brandName', 'pros', 'cons', 'specifications'],
        [$_POST['name'], $_POST['description'], $target_file, $_POST['retailPrice'], $_POST['productCost'], $_POST['oldCar'], $_POST['ownerId'], $_POST['sold'], $_POST['brandName'], $_POST['pros'], $_POST['cons'], $_POST['specifications']]
    );
    if ($record_success) {
?>
    <script>
